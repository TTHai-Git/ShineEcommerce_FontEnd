...
var App = {
  ...
  InitLazyLoad: function () {
    return new LazyLoad({ elements_selector: ".lazy" });
  },
};
...
function MobileToggleSearchBox() {
  $("header .search-icon").on("click", function () {
    $(this).toggleClass("active"),
      $("header .toggle-wrapper>ul.active").length &&
...
function RateActive() {
  $(".rate").each(function () {
    var e = $(this).attr("data-rate");
    $(this).find("em:lt(".concat(e, ")")).addClass("active");
  });
}
function BackToTop() {
...
function ProductDetailSlider() {
  var e = new Swiper(".product-detail .image-thumb .swiper-container", {
    spaceBetween: 10,
    slidesPerView: 4,
    freeMode: !0,
  ...
  new Swiper(".product-detail .image-top .swiper-container", {
    spaceBetween: 10,
    thumbs: { swiper: e },
    navigation: {
    ...
    new Swiper(".product-detail .viewed-products-wrapper .swiper-container", {
      slidesPerView: 6,
      speed: 1e3,
      spaceBetween: 30,
      navigation: {
      ...
      breakpoints: {
        ...
        1430: { slidesPerView: 4 },
      },
    }),
    new Swiper(".product-detail .product-reviews-wrapper .swiper-container", {
      slidesPerView: 5,
      speed: 1e3,
      spaceBetween: 30,
      navigation: {
    ...
    new Swiper(".related-products-wrapper .swiper-container", {
      slidesPerView: 6,
      speed: 1e3,
      spaceBetween: 30,
      navigation: {
